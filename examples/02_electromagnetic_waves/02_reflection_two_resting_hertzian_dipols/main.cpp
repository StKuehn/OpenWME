...
int main()
{
	...
	// set position
	Reflector->SetLinearTrajectory(TVector(30 * cm, 0, 0), TVector(0, 0, 0));
	...
	TDisplay display(700, 700, -50 * cm, -50 * cm, 50 * cm, 50 * cm, "Reflection of an EM pulse between to resting Hertzian dipoles");
